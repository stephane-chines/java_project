...
public class Set 
{
            ...
            StatistiquesMatch statsJoueur1, StatistiquesMatch statsJoueur2, List<Spectateur> spectateurs) 
    {
		...
		this.premierServeurProchainSet = null; 
    }
    ...
    public void jouerSet(ModeJeu mode, boolean afficherDetails) 
    {
        while (vainqueur == null) 
        {
            ...
            {
				// On mémorise qui a servi en premier le tie-break
				...
				// Maintenant que les getters existent, on mémorise le détail du tie-break
